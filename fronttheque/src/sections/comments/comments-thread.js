    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <Grid container xs={12} sx={{ alignItems: 'top' }}>
                            ...
                            >
                                {(comment.children.length !== 0) && <>
                                    ...
                                    <Tooltip title={showThread ? "See less" : "See Thread"}>
                                        <SvgIcon fontSize='small' sx={{ cursor: 'pointer' }} onClick={onViewThreadClick}>
                                            {showThread ? <MinusIcon /> : <ChatBubbleLeftEllipsisIcon />}
                                        </SvgIcon>
                                    </Tooltip> </>}
                                {!open && canDelete && <SvgIcon fontSize='small' sx={{ cursor: 'pointer' }} onClick={()=> setOpen(true)}>
                                    <TrashIcon />
                                </SvgIcon> }
