...
urlpatterns = [ 
    ...
    path('materials/category/<str:category>/', material_views.get_materials_by_category, name='materials_by_category'), # Route to get materials based on category
    path('materials/availability/<str:category>/', material_views.check_material_availability, name='check_material_availability'), # Route to check availability of materials based on category
