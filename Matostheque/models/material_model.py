...
LAB_SUPPLY_TYPE_CHOICES = [
    ...
    ('BUILDINGS_INFRASTRUCTURE_WORKS_GREEN_SPACES', 'Building, Infrastructure, Works and Green spaces'),
    ('COMMUNICATION_CULTURE_DOCUMENTATION', 'Communication, Culture and Documentation'),
    ('TRAVEL_TRANSPORT_ACCOMMODATION', 'Travel : Transport and Accomodation '),
    ('STUDIES_CONSULTING_INSURANCE_PI_HUMAN_RESOURCES', 'Studies, Consulting, Insurance, Human Resources'),
    ('FREIGHT_SHIPPING_TRANSPORT_MOVING', 'Freight, Shipping, Transport and Moving'),
    ('LABORATORY_WORKSHOP_GASES_CRYOGENICS',  'Laboratories or Workshop Gases, Cryogenics '),
    ('HYGIENE_SAFETY',  'Hygiene and Safety at Work'),
    ('IT_TELECOMMUNICATIONS_AUDIOVISUAL',  'IT, Telecommunications and Audiovisual'),
    ('LABORATORY_TP_ROOM_FITTINGS',  'Laboratory and TP Room Fittings'),
    ('ANIMAL_EXPERIMENTATION_ANIMAL_BREEDING_ANIMAL_CONSERVATION_ANIMAL_STUDIES',  'Animal Experimentation, Animal Breeding, Animal Conservation and Animal Studies'),
    ('MEDICAL',  'Mecidal'),
    ('MICROSCOPY_PROFILOMETRY',  'Microscopy and Profilometry'),
    ('CHEMISTRY_BIOLOGY',  'Chemistry and Biology'),
    ('OPTO_LASERS_OPTICAL_EQUIPMENT',  'Opto, Lasers and Optical Equipement'),
    ('PHYSICS_NUCLEAR_CORPUSCULAR_PHYSICS',  'Physics, Nuclear and Corpuscular Physics'),
    ('PLANT_EXPERIMENTATION',  'Plant Experimentation'),
    ('WORKSHOP_MECHANICS_AUTOMATION',  'Workshop, Mechanics and Automation'),
    ('SPECTROMETRY_SPECTROSCOPY_X-RAYS',  'Spectrometry, Spectroscopy and X-rays'),
    ('ELECTRONICS_TEST_ENERGY_MEASUREMENT',  'Electronics or Tests, Energy and Measurement'),
    ('ARTH_SCIENCES_GEOPHYSICS_ASTROPHYSICS_ARCHAEOLOGY',  'Arth Sciences, Geophysics, Astrophysics and Archaeology'),
    ('VACUUM_VACUUM_TECHNOLOGY_EQUIPMENT',  'Vacuum and Vacuum Technology Equipment'),
    ('NANOTECHNOLOGIES_MICROELECTRONICS',  'Nanotechnologies and Microelectronics'),
    ('NON_PURCHASING_EXPENSES',  'Non Purchasing Expenses')
]
#############################################################
...
class Materials(models.Model):
    ...
    quantity_available =  models.FloatField(default=0.0, null=True) # The quantity of the material available. (consumable type)
    unit = models.CharField(max_length=100, null=True, blank=True)  # The unit of measurement for the material. (consumable type)
    expiration_date = models.DateTimeField(null=True, blank=True)   # The expiration date of the material. (consumable type)
    ##################################################################################################
